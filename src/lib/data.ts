import { TEducation, TPersonalInfo, TProject, TSkill, TWorkExperience } from "@/lib/types";
...
export const SkillsData: TSkill[] = [
	...
	},
	{
		...
		items: ["React", "Next.js", "Angular", "Redux", "HTML", "CSS", "Tailwind CSS"],
	},
	{
		category: "Backend Development",
		items: ["ASP.NET Core", "Node.js", "Express", "Django", "GraphQL", "REST APIs"],
	},
	{
		category: "Databases",
	...
	},
	{
		...
		items: ["Docker", "Kubernetes", "Git", "CI/CD Pipelines", "AWS", "Azure", "Jenkins"],
	},
	{
		category: "Testing",
